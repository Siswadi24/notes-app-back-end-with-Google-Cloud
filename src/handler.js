...
const addNotesHandler = (request, h) => {
  ...
  const response = h.response({
    status: 'fail',
    messsage: 'Catatan gagal ditambahkan',
  });
  response.code(500);
  return response;
};
...
module.exports = {
  addNotesHandler, getAllNotesHandler, getNotesByIdHandler, editNotesByIdHandler, deleteNotesByIdHandler,
};
